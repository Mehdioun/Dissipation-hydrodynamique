    ...
    while True:
        ...
        if msvcrt.kbhit():  # Vérifie si une touche est en attente
            ...
            if key == 'q':  # Quitter la boucle si 'q' est pressé
                ...
                GOAL_VELOCITY = 0
            elif key == '/': # Inverser le sens de rotation
                ...
                GOAL_VELOCITY = int(vitesse_rota(100))
            elif key == 'z' : # 150 mm/s
                GOAL_VELOCITY = int(vitesse_rota(150))
            elif key == 'e' : # 200 mm/s
                GOAL_VELOCITY = int(vitesse_rota(200))
            elif key == 'r' : # 250 mm/s
                GOAL_VELOCITY = int(vitesse_rota(250))
            elif key == 't' : # 300 mm/s 
                GOAL_VELOCITY = int(vitesse_rota(300))
            elif key == 'y' : # 350 mm/s
                GOAL_VELOCITY = int(vitesse_rota(350))
            elif key == 'u' : # 400 mm/s
                GOAL_VELOCITY = int(vitesse_rota(400))
            elif key == 'i' : # 450 mm/s
                GOAL_VELOCITY = int(vitesse_rota(450))
            elif key == 'o' : # 500 mm/s
                GOAL_VELOCITY = int(vitesse_rota(500))
            elif key == 'p' : # 550 mm/s
                GOAL_VELOCITY = int(vitesse_rota(50))
